...
import com.example.attack.entity.api.SubjectPostApi;
import com.example.attack.entity.api.UploadApi;
import com.example.attack.entity.resulte.RetrofitEntity;
import com.example.attack.entity.resulte.SubjectResulte;
import com.example.attack.entity.resulte.UploadResulte;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_rx_uploade:
                uploadeDo();
                break;
            case R.id.btn_rx_mu_down: //多任务下载
